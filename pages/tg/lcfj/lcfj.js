...
Page({
    ...
    onLoad: function() {
        ...
        }), r.collection("equipment").doc("tgdps").get({
            success: function(t) {
                console.log(t);
                var e = [], r = t.data.equipListTGD;
                for (var n in r) {
                    var i = [];
    ...
    drawCanvas: function() {
        ...
        Promise.all([ t, e ]).then(function(t) {
            ...
            e.fillText("古剑奇谭网络版配装器", 250, 40), e.setFontSize(24), e.fillText("门派：天罡    专精：龙城飞将", 450, 80), 
            e.setFontSize(18);
