...
Page({
    ...
    onLoad: function() {
        ...
        }), r.collection("equipment").doc("zydps").get({
            success: function(t) {
                console.log(t);
                var e = [], r = t.data.equipListZYD;
                for (var n in r) {
                    var i = [];
    ...
    updatePorperty: function() {
        ...
        a.propertyList[this.data.攻击].value += .3 * a.propertyList[this.data.属性].value, a.propertyList[this.data.会心].value += .7 * a.propertyList[this.data.属性].value, 
        a.propertyList[this.data.强度].value += .5 * a.propertyList[this.data.属性].value, a.propertyList[this.data.属性].value += 40, 
        ...
        a.propertyList[this.data.攻击].value += .3 * s * 1.2, a.propertyList[this.data.会心].value += .7 * s, 
        a.propertyList[this.data.强度].value += .5 * s, a.propertyList[this.data.属性].percent = a.propertyList[this.data.属性].value + s, 
    ...
    drawCanvas: function() {
        ...
        Promise.all([ t, e ]).then(function(t) {
            ...
            e.fillText("古剑奇谭网络版配装器", 250, 40), e.setFontSize(24), e.fillText("门派：咒隐    专精：窃冥蛊咒", 450, 80), 
            e.setFontSize(18);
